...
- [puppeteer-theater](https://github.com/nicoandmee/puppeteer-theater) - Complete automation framework for automating, scraping, and performing advanced puppeteer workflows with elegance, ease, and whilst remaining undetected.
